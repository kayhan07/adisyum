...
const FEATURES = [
  ...
  },
  {
    ...
    description: 'Müşteriler masadan QR okuyarak sipariş verir ve hesap ister. Görsel, premium, ultra hızlı.',
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <ul className="mt-6 space-y-3">
                {['Öncelik sıralaması ve gecikme uyarısı', 'Servis ekranı bildirimleri', 'Multi-printer routing (mutfak/bar/tatlı)', 'Yazıcı bağlantı kaybında otomatik kuyruk'].map((item) => (
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="lg:order-1">
              ...
              <p className="mt-4 text-slate-400 leading-relaxed">
                ...
                Hesap isteme de aynı ekranda.
              </p>
              <ul className="mt-6 space-y-3">
                {['Anlık görsel güncelleme (stok binişi)', 'Hesap iste', 'Sepet yönetimi — siparişi onaylamadan gönderme', 'Tamamen özelleştirilebilir marka + renk'].map((item) => (
                  <li key={item} className="flex items-start gap-3 text-sm text-slate-300">
                    <svg viewBox="0 0 20 20" fill="currentColor" className="mt-0.5 h-4 w-4 flex-shrink-0 text-brand-400">
                      <path fillRule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clipRule="evenodd" />
                    </svg>
